class GanjilGenap(object):
    ...
    def compare_angka(self):
        ...
        if self.angka_1 == self.angka_2:
            number_result = f"{self.angka_1} sama dengan {self.angka_2}"
        elif self.angka_1 > self.angka_2:
            number_result = f"{self.angka_1} lebih besar dari {self.angka_2}"
        else:
            number_result = f"{self.angka_1} lebih kecil dari {self.angka_2}"
